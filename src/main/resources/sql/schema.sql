...
-- COMMENT ON COLUMN member.cre_time IS '생성 시간';
-- COMMENT ON COLUMN member.cre_member_id IS '생성자';
-- COMMENT ON COLUMN member.upd_time IS '수정 시간';
-- COMMENT ON COLUMN member.upd_member_id IS '수정자';
